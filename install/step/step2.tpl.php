<?php include ALI_PATH.'install/step/header.tpl.php';?>
	<div class="body_box">
        <div class="main_box">
            <div class="hd">
	 ...
	 <table cellpadding="0" cellspacing="0" class="table_list">
                  ...
                  <tr>
                    ...
                    <td>PHP 5.5.0 及以上</td>
                    <td><?php if(phpversion() >= '5.5.0'){ ?><span><img src="images/correct.gif" /></span><?php }else{ ?><font class="red"><img src="images/error.gif" />&nbsp;无法安装</font><?php }?></font></td>
                  </tr>
                  <tr>
                    <td>MYSQLI 扩展</td>
                  ...
                  <tr>
                    ...
                    <td>必须开启</td>
                    <td><?php if(extension_loaded('iconv') || extension_loaded('mbstring')){ ?><span><img src="images/correct.gif" /></span><?php }else{ ?><font class="red"><img src="images/error.gif" />&nbsp;无法安装</font><?php }?></td>
                  </tr>
                  ...
                  <tr>
                    <td>ZIP 扩展</td>
                    <td><?php if(extension_loaded('zip')){ ?>√<?php }else{ ?>×<?php }?></td>
                    <td>必须开启</td>
                    <td><?php if(extension_loaded('zip')){ ?><span><img src="images/correct.gif" /></span><?php }else{ ?><font class="red"><img src="images/error.gif" />&nbsp;无法安装</font><?php }?></td>
                  </tr>
                  <tr>
                    <td>allow_url_fopen</td>
                    <td><?php if(ini_get('allow_url_fopen')){ ?>√<?php }else{ ?>×<?php }?></td>
                    <td>必须开启</td>
                    <td><?php if(ini_get('allow_url_fopen')){ ?><span><img src="images/correct.gif" /></span><?php }else{ ?><font class="red"><img src="images/error.gif" />无法安装</font><?php }?></td>
                  </tr>
            ...
            <?php }else{ ?>
			<a onClick="alert('当前配置不满足阿里蜘蛛池安装需求，无法继续安装！');" class="x_btn pre">检测不通过</a>
 			<?php }?>
